// This maps split names to body parts
...
export const defaultExercises = [
  ...
  { id: 'ch_6', name: 'Dips', bodyPart: 'Chest', category: 'Bodyweight' },

  // --- SHOULDERS (Push) ---
  { id: 'sh_1', name: 'Overhead Press', bodyPart: 'Shoulders', category: 'Barbell' },
  { id: 'sh_2', name: 'Lateral Raise', bodyPart: 'Shoulders', category: 'Dumbbell' },
  { id: 'sh_3', name: 'Face Pull', bodyPart: 'Rear Delts', category: 'Cable' },
  { id: 'sh_4', name: 'Arnold Press', bodyPart: 'Shoulders', category: 'Dumbbell' },

  // --- TRICEPS (Push) ---
  { id: 'tr_1', name: 'Tricep Pushdown', bodyPart: 'Triceps', category: 'Cable' },
  ...
  { id: 'bi_3', name: 'Preacher Curl', bodyPart: 'Biceps', category: 'Machine' },
  ...
  { id: 'lg_7', name: 'Calf Raise', bodyPart: 'Calves', category: 'Machine' },
];